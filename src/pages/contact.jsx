...
export default function Contact() {
  return (
    <div className="bg-[#fcf9f8] text-[#1c1b1b] font-sans overflow-x-hidden">
      ...
      {/* Hero */}
      <Hero
        judul="kunsultasi Ekslusif"
        deskripsi="Wujudkan busana impian Anda melalui sentuhan tangan ahli. Jadwalkan pertemuan pribadi dengan penjahit utama kami untuk mendiskusikan desain, bahan, dan ukuran yang sempurna."
      />
